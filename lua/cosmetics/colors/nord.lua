...
local basic_scheme = function()
  ...
  hi('LineNr', {
    guifg = M.brightened_comments[11],
    ctermfg = nord3_term
  })
  hi('MatchParen', {
    guifg = nord8_gui,
...
local setup_plugin_colors = function()
  ...
  hi('SignifySignChangeDelete', {
    guifg = nord11_gui,
    ctermfg = nord11_term
  })
  hi('SignifySignDelete', {
    guifg = nord11_gui,
    ctermfg = nord11_term
  })
  -- HOP.nvim
  hi('HopUnmatched', {
    guifg = M.brightened_comments[13],
    ctermfg = nord8_term
  })
  hi('HopNextKey', {
    guifg = nord_jump_gui,
  ...
  hi('StFileName', {
    guifg = M.brightened_comments[16],
    gui = 'bold'
  })
  hi('StGitBranch', {
    guifg = M.brightened_comments[19]
  })
