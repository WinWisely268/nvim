...
local function diag_status()
	...
	if buf_diagnostics.errors and buf_diagnostics.errors > 0 then
		table.insert(parts, "%#DiagErr#"..icons.deviconTable["errors"]..buf_diagnostics.errors.." ")
	end
	if buf_diagnostics.warnings and buf_diagnostics.warnings > 0 then
		table.insert(parts, "%#DiagWarning#"..icons.deviconTable["warnings"]..buf_diagnostics.warnings.." ")
	end
	if buf_diagnostics.hints and buf_diagnostics.hints > 0 then
		table.insert(parts, "%#DiagHint#"..icons.deviconTable["hints"]..buf_diagnostics.hints.." ")
	end
...
function M.activeLine()
	...
	-- Component: Git
	statusline = statusline.."%#DirSeparator#"..left_separator.."%#GitStatus# "..git_status().."%#DirSeparator#"..right_separator
	statusline = statusline..blank
	...
	statusline = statusline.."%#DirSeparator#"..left_separator.."%#GitStatus#"..dstatus().."%#DirSeparator#"..right_separator
	statusline = statusline..blank
