...
local basic_scheme = function()
  ...
  hi('Cursor',
     {guifg = fg0[1]; guibg = blue[1]; ctermfg = fg0[2]; ctermbg = blue[2]})
  hi('CursorLine', {guibg = bg1[1]; ctermbg = bg1[2]})
  -- hilink('iCursor', 'Cursor')
  hi('LineNr',
     {guifg = grey0[1]; guibg = bg1[1]; ctermfg = grey0[2]; ctermbg = bg1[2]})
...
local setup_misc = function()
  ...
  hi('StatusLine', {guifg = grey0[1]; guibg = bg0[1]; ctermfg = fg1[2]})
  hi('StatusLineNC', {guifg = grey0[1]; guibg = bg0[1]; ctermfg = grey2[2]})
  ...
  hi('DiffText', {guifg = blue[1]; ctermfg = blue[2]})
end
