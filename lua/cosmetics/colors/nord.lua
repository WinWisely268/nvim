...
local basic_scheme = function()
    ...
    hi('PmenuThumb',
       {guifg = nord8_gui, guibg = nord3_gui, ctermbg = nord3_term})
...
local setup_misc = function()
    ...
    hi('FoldColumn',
       {guifg = nord3_gui, guibg = nord0_gui, ctermfg = nord3_term})
    hi('SignColumn',
       {guifg = nord1_gui, guibg = nord0_gui, ctermfg = nord1_term})
    hi('Directory', {guifg = nord8_gui, ctermfg = nord8_term})
    hi('EndOfBuffer', {guifg = nord1_gui, ctermfg = nord1_term})
    hi('Error', {})
    hi('ErrorMsg',
       {guifg = nord4_gui, guibg = nord11_gui, ctermbg = nord11_term})
...
local setup_langbase = function()
    ...
    hi('Comment', {
        guifg = M.brightened_comments[23],
        ctermfg = nord3_term,
        gui = 'italic'
    })
    ...
    hi('SpecialComment',
       {guifg = nord8_gui, ctermfg = nord8_term, gui = 'italic'})
